...
ubuntu20_dep() {
  ...
  apt -y install php8.0 php8.0-{cli,gd,pdo,mbstring,tokenizer,bcmath,xml,fpm,curl,zip} nginx tar unzip git redis-server redis cron
...
debian_stretch_dep() {
  ...
  # Install Dependencies
  apt -y install php8.0 php8.0-{cli,gd,pdo,mbstring,tokenizer,bcmath,xml,fpm,curl,zip} nginx curl tar unzip git redis-server cron
